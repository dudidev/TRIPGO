...
export class Contact {
  ...
  onSubmit(): void {
    ...
    const payload = {
      nombre_establecimiento: this.name.value!.trim(),

      nombre_contacto: this.name.value!.trim(),

      correo_contacto: this.email.value!.trim(),

      descripcion: `
        Tipo de negocio: ${this.selectedType}

        Teléfono: ${this.phone.value!.trim()}
